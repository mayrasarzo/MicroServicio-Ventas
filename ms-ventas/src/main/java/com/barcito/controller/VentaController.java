...
public class VentaController {
    ...
    @GetMapping(value = "/mesas/buscar/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<MesaDto> buscarMesaPorId(@PathVariable int id) throws Exception {
        Mesa mesa = ventaService.buscarMesaPorId(id);
        return new ResponseEntity<>(mesa.toDto(), HttpStatus.OK);
    }
}
